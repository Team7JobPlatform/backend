package com.SW.SW.domain.user.controller;

import com.SW.SW.config.JwtTokenProvider;
import com.SW.SW.domain.user.entity.Scrap;
import com.SW.SW.domain.user.service.ScrapService;
import com.SW.SW.domain.user.dto.MyPageResponseDto;
import com.SW.SW.domain.user.entity.User;
import com.SW.SW.domain.user.service.UserService;
